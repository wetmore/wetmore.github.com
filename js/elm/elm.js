...
Elm.Duration.make = function (_elm) {
   ...
   if (_elm.Duration.values)
   return _elm.Duration.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var thresholds = {_: {}
                    ...
                    ,m: 45
                    ,s: 45};
   var inDays = function (t) {
      return $Time.inHours(t) / 24.0;
   };
   var humanize = function (t) {
      return function () {
         var days = inDays(t);
         var hours = $Time.inHours(t);
         var minutes = $Time.inMinutes(t);
         var seconds = $Time.inSeconds(t);
         var howMany = _U.cmp(hours,
         thresholds.h) > 0 ? {ctor: "_Tuple2"
                             ,_0: days
                             ,_1: "day"} : _U.cmp(minutes,
         thresholds.m) > 0 ? {ctor: "_Tuple2"
                             ,_0: hours
                             ,_1: "hour"} : _U.cmp(seconds,
         thresholds.s) > 0 ? {ctor: "_Tuple2"
                             ,_0: minutes
                             ,_1: "minute"} : {ctor: "_Tuple2"
                                              ,_0: seconds
                                              ,_1: "second"};
         var rounded = $Basics.ceiling($Basics.fst(howMany));
         var pluralized = _U.eq(rounded,
         1) ? "" : "s";
         return A2($Basics._op["++"],
         $Basics.toString(rounded),
         A2($Basics._op["++"],
         " ",
         A2($Basics._op["++"],
         $Basics.snd(howMany),
...
Elm.TimeMachine = Elm.TimeMachine || {};
Elm.TimeMachine.make = function (_elm) {
   "use strict";
   _elm.TimeMachine = _elm.TimeMachine || {};
   if (_elm.TimeMachine.values)
   return _elm.TimeMachine.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TimeMachine",
   $Basics = Elm.Basics.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var every$ = F3(function (o,
   d,
   mult) {
      return function () {
         var f = F2(function (x,s) {
            return function () {
               switch (s.ctor)
               {case "_Tuple2":
                  switch (s._0.ctor)
                    {case "Just":
                       return {ctor: "_Tuple2"
                              ,_0: $Maybe.Just(s._0._0)
                              ,_1: o + mult * (x - s._0._0) + s._0._0};
                       case "Nothing":
                       return {ctor: "_Tuple2"
                              ,_0: $Maybe.Just(x)
                              ,_1: o + x};}
   ...
   _elm.TimeMachine.values = {_op: _op
                             ,every$: every$};
   return _elm.TimeMachine.values;
};
...
Elm.Trips = Elm.Trips || {};
Elm.Trips.make = function (_elm) {
   "use strict";
   _elm.Trips = _elm.Trips || {};
   if (_elm.Trips.values)
   return _elm.Trips.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var timeOf = function (e) {
      return function () {
         ...
         var d = function () {
            ...
            _U.badCase($moduleName,
            "on line 50, column 14 to 20");
         }();
         return $Date.toTime(d);
      }();
   };
   var places = $Json$Decode.customDecoder($Json$Decode.string)(function (s) {
      return function () {
         var _v3 = $List.map($String.trim)(A2($String.split,
         "->",
         s));
         switch (_v3.ctor)
         {case "::": switch (_v3._1.ctor)
              {case "::":
                 switch (_v3._1._1.ctor)
                   ...
                   break;}
              break;}
         return $Result.Err("Expecting \'place1 -> place2\' format");
      }();
   });
   var timeZ = function () {
      ...
      "timeZone",
      $Json$Decode.string)));
      return $Json$Decode.customDecoder(decoder)(function (_v8) {
         return function () {
            switch (_v8.ctor)
            {case "_Tuple2":
               return A2($Result.map,
                 ...
                 $Date.fromString(_v8._0));}
            _U.badCase($moduleName,
            "on line 34, column 13 to 56");
         }();
      });
   }();
   var event = function () {
      var makeEvents = F3(function (_v12,
      t1,
      t2) {
         return function () {
            switch (_v12.ctor)
   ...
   var mydecoder = $Json$Decode.map(function ($) {
      return $List.sortBy(timeOf)($List.concat($));
   })(A2($Json$Decode._op[":="],
   "items",
   $Json$Decode.list(event)));
   var url = F2(function (cal,
   key) {
      return $String.concat(_L.fromArray(["https://www.googleapis.com/calendar/v3/calendars/"
                                         ,$Http.uriEncode(cal)
                                         ,"/events?key="
                                         ,$Http.uriEncode(key)]));
   });
   var calendar = "vi3sulr1267gn05fs4pb3447q8@group.calendar.google.com";
   var apiKey = "AIzaSyBXiYL4SqSsH8I0j8xyYquJq747Zmcl9oQ";
   var getEvents = $Http.get(mydecoder)(A2(url,
   calendar,
   apiKey));
...
Elm.WhereIsMatt = Elm.WhereIsMatt || {};
Elm.WhereIsMatt.make = function (_elm) {
   "use strict";
   _elm.WhereIsMatt = _elm.WhereIsMatt || {};
   if (_elm.WhereIsMatt.values)
   return _elm.WhereIsMatt.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "WhereIsMatt",
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   ...
   $Task = Elm.Task.make(_elm),
   $Time = Elm.Time.make(_elm),
   $Trips = Elm.Trips.make(_elm);
   var events = $Signal.mailbox(_L.fromArray([]));
   var report = function (es) {
      return A2($Signal.send,
      events.address,
      es);
   };
   var fetchEvents = Elm.Native.Task.make(_elm).perform(A2($Task.andThen,
   $Trips.getEvents,
   report));
   var toJS = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                    ...
                    switch (_v0._1._1.ctor)
                      {case "_Tuple2":
                         return {ctor: "_Tuple3"
                                ,_0: "travel"
                                ,_1: _v0._1._0
                                ,_2: (_v0._0 - _v0._1._1._0) / (_v0._1._1._1 - _v0._1._1._0)};}
                      break;}
                 _U.badCase($moduleName,
                      ...
                      switch (_v29._1._1.ctor)
                        {case "_Tuple2":
                           return A2($Basics._op["++"],
                             ...
                             ", for ",
                             A2($Basics._op["++"],
                             $Duration.humanize(_v29._1._1._1 - _v29._1._1._0),
                             "."))));}
                        break;
                      case "Travel":
                      switch (_v29._1._1.ctor)
                      ...
                      switch (_v29._1._1.ctor)
                        {case "_Tuple2":
                           return A2($Basics._op["++"],
                             ...
                             ", for the next ",
                             A2($Basics._op["++"],
                             $Duration.humanize(_v29._1._1._1 - t),
                             "."))));}
                        break;
                      case "Travel":
                      switch (_v29._1._1.ctor)
   ...
   var makePastAndFuture = function (_v48) {
      return function () {
         switch (_v48.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: A2($List.partition,
                   function (a) {
                      return _U.cmp(end(a),
                      _v48._1) < 0;
                   },
      ...
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v52._1};}
         _U.badCase($moduleName,
         "on line 39, column 19 to 25");
      }();
   });
   var withCurrentTime = A2($Signal.map2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   }),
   events.signal)($Time.every($Time.minute));
   var para = function (s) {
      return A2($Html.p,
      _L.fromArray([]),
   ...
   var showTime = function ($) {
      return para($Date$Format.format("%H:%M, %B %e")($Date.fromTime($)));
   };
   var tonight = 1435122090000;
   var day = 24 * $Time.hour;
   var week = 7 * day;
   var Next = {ctor: "Next"};
   var Now = {ctor: "Now"};
   var tell$ = F2(function (t,
   acts) {
      return function () {
         var explainNext = A2(explain$,
         t,
         Next);
         var explainNow = A2(explain$,
         t,
         Now);
         return function () {
            switch (acts.ctor)
               ...
               switch (acts._1.ctor)
                 {case "::":
                    return A2($Basics._op["++"],
                      ...
                      A2($Basics._op["++"],
                      " Next he ",
                      explainNext(acts._1._0))));}
                 return A2($Basics._op["++"],
                 "Matt ",
                 explainNow(acts._0));
               case "[]":
               return "No info about what Matt is doing. Try asking him?";}
            _U.badCase($moduleName,
            "between lines 61 and 64");
         }();
      }();
   });
   var tell = function (_v61) {
      return function () {
         switch (_v61.ctor)
         {case "_Tuple2":
            switch (_v61._0.ctor)
              ...
              break;}
         _U.badCase($moduleName,
         "on line 67, column 25 to 39");
      }();
   };
   var Travel = F2(function (a,b) {
      return {ctor: "Travel"
             ,_0: a
             ,_1: b};
   });
   var Stay = F2(function (a,b) {
      return {ctor: "Stay"
             ,_0: a
             ,_1: b};
   });
   var activities = function (events) {
      return function () {
         var helper = F2(function (l1,
         l2) {
            return _U.eq(l1,
            l2) ? l1 : A2($Basics._op["++"],
            l1,
         ...
         return function () {
            switch (events.ctor)
            {case "::":
               switch (events._1.ctor)
                 {case "::": return function () {
                         var _v72 = events._0.what;
                         switch (_v72)
                         {case "arrive":
                            return A2($List._op["::"],
                              A2(Stay,
                              ...
                              events._1._0.place),
                              {ctor: "_Tuple2"
                              ,_0: $Trips.timeOf(events._0)
                              ,_1: $Trips.timeOf(events._1._0)}),
                              activities(A2($List._op["::"],
                              events._1._0,
                              events._1._1)));
                            case "depart":
                            return A2($List._op["::"],
   ...
   var pastAndFuture = A2($Signal.map,
   function ($) {
      return makePastAndFuture(mapFst(function ($) {
         return addMontreal(activities($));
      })($));
   },
   withCurrentTime);
   var updateMapSignal = $Signal.map(toJS)($Time.timestamp(A2($Signal.filterMap,
   function ($) {
      return $List.head($Basics.snd($));
   },
   A2(Stay,
   "Nowhere",
   {ctor: "_Tuple2"
   ,_0: 0
   ,_1: 0}))($Signal.dropRepeats(A2($Signal.map,
   $Basics.fst,
   pastAndFuture)))));
   var updateMap = Elm.Native.Port.make(_elm).outboundSignal("updateMap",
   function (v) {
   ...
   pastAndFuture);
   _elm.WhereIsMatt.values = {_op: _op
                             ,Stay: Stay
                             ,Travel: Travel
                             ,Now: Now
                             ,Next: Next
                             ...
                             ,updateMapSignal: updateMapSignal
                             ,mapFst: mapFst
                             ,main: main
                             ,makePastAndFuture: makePastAndFuture
